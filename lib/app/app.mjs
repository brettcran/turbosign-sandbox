// TurboSign v4.5 — Sleek larger SVG icons, centered midpoint pinch zoom,
// text/stamp/sign tools, signature modal, photo/scan modal (camera or file),
// draggable/resizable images, robust save via pdf-lib (ESM).
// -----------------------------------------------------------------------------------------
...
/* ---------- Centered Zoom (midpoint anchored) ---------- */
const zoom = {
  scale: 1,
  min: 0.6,
  max: 3,
...
/* ---------- Toolbar (exclusive tools; active ring) ---------- */
...
document.addEventListener('DOMContentLoaded', ()=>{
  // (no-op) — everything is wired above
});