/* lib/app/app.mjs — signatures placed by double‑click/tap at pointer location.
   Signature button ALWAYS opens modal to redraw. */
...
let LAST_SIG_DATAURL = null; // cached signature for placement
...
class Annotations {
  ...
  _wireAnno(el, overlay, {resizable}){
    const startDrag=(e)=>{
      ...
      const {x,y}=this._pos(ov erlay,e);
